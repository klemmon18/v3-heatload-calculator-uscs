...
const App: React.FC = () => {
  const [surfaces, setSurfaces] = useState<SurfaceInput[]>([
    { id: '1', name: 'Wall 1', type: 'Wall', width: 10, height: 8, rValue: InsulationRValue.R19, isExterior: false, sunExposed: false, glassWidth: 0, glassHeight: 0, glassType: GlassType.None, hasDoor: false, doorWidth: 3, doorHeight: 7, doorType: DoorType.SolidCore },
    { id: '2', name: 'Wall 2', type: 'Wall', width: 10, height: 8, rValue: InsulationRValue.R19, isExterior: false, sunExposed: false, glassWidth: 0, glassHeight: 0, glassType: GlassType.None, hasDoor: false, doorWidth: 3, doorHeight: 7, doorType: DoorType.SolidCore },
    { id: '3', name: 'Wall 3', type: 'Wall', width: 8, height: 8, rValue: InsulationRValue.R19, isExterior: false, sunExposed: false, glassWidth: 0, glassHeight: 0, glassType: GlassType.None, hasDoor: false, doorWidth: 3, doorHeight: 7, doorType: DoorType.SolidCore },
    { id: '4', name: 'Wall 4', type: 'Wall', width: 8, height: 8, rValue: InsulationRValue.R19, isExterior: false, sunExposed: false, glassWidth: 0, glassHeight: 0, glassType: GlassType.None, hasDoor: false, doorWidth: 3, doorHeight: 7, doorType: DoorType.SolidCore },
  ...
  console.log("RESULT BREAKDOWN", result.breakdown);
                          ...
                          <div className="flex items-center gap-1.5">
                            <div className="w-[64px] bg-white border border-slate-200 px-2 py-3 text-sm font-bold text-left tabular-nums text-slate-800 focus:border-[#7A1C2D] outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none">
                              ...
                              <input
                                ...
                                onFocus={(e) => e.target.select()}
                                className="w-[45px] bg-white border border-slate-200 rounded-none px-3 py-2.5 text-[16px] leading-none font-bold text-left text-slate-800 focus:border-[#7A1C2D] outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                  ...
                  {isCalculable && infoConfirmed ? (
                    <div className="grid grid-cols-2 gap-8 animate-in fade-in duration-700">
                      ...
                      <div className="bg-slate-50 p-6 rounded-none border border-slate-100 shadow-sm">
                        ...
                        <div className="text-2xl font-black text-[#333333] tracking-tighter font-montserrat">{Math.round(((result.breakdown.qLighting ?? 0) + (result.breakdown.qPeople ?? 0) + (result.breakdown.qAppliances ?? 0) + (result.breakdown.qExtra ?? 0)) / 16)}</div>
                      </div>
                      <div className="bg-slate-50 p-6 rounded-none border border-slate-100 shadow-sm">
